...
function bones_scripts_and_styles() {
  if (!is_admin()) {
    ...
    // register jQuery Cycle in the footer
    // wp_register_script( 'cycle-lite', get_stylesheet_directory_uri() . '/library/js/libs/jquery.cycle.lite.js', array(), '', true);    
